        ...
        <form action="validar-pago" method="POST" modelAttribute="datosDePago">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input id="numTarjeta" type="number" class="form-control">
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input id="cvv" type="number" class="form-control" maxlength="3" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
              <img src="<c:url value="/images/cvv.png" />" style="width: 12%; margin: -20% 0 0 85%;">
            </div>
          </div>
