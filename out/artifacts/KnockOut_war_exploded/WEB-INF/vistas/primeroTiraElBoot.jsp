          ...
          <%-- -------------------------- --%>
            ...
            <div class="d-flex justify-content-evenly">
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 pb-5">
                <div class="card shadow-sm border-1 shadow-lg rounded">
                  <div class="card-body p-0">
                    <img src="<c:url value="/images/personaje_vacio.png" />" class="w-100 card-img-top" style="height: 418px;">
                    <div class="p-4">
                      <h5 class="mb-0 text-center">Personaje a elegir</h5>
                      <br>
...
<%--                      </div>--%>
              ...
              <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 pb-5">
                <div class="card shadow-sm border-1 shadow-lg rounded">
                  <div class="card-body p-0">
                    <img src="<c:url value="/images/personajes/${random1.imagen}" />" class="w-100 card-img-top">
                    <div class="p-4">
                      <h5 class="mb-0 text-center">${random1.nombre}</h5>
                      <br>
