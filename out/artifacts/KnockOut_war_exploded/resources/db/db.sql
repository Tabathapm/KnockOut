...
values('Ermac','ermac.jpg',
      ...
      ('Shang Tsung','st.jpg','Es un poderoso hechicero con la capacidad de absorber almas y cambiar de forma. Bajo el mando de Shao Kahn buscara conquistar la tierra.',true,false,9200.00),
