...
INSERT INTO personaje(nombre, imagen,intercambiable, descripcion, enVenta, enMiColeccion, monto)
VALUES
...
('Thor', 'thor_.jpg',false, 'Dios del trueno y fuerza en la mitología nórdica y germánica' ,true, false, 10500.50),
...
('Ultron', 'ultron_.jpg',false, 'Inteligencia artificial que trata de eliminar a los superheroes.' ,true, false, 6000.0),
...
values('Ermac','ermac.jpg',false,
      ...
      ('Scorpion','scorpion.jpg',false,'Espectro Ninja no muerto que busca venganza por su propia muerte a manos de Sub-Zero.',true,false,10000.00),
      ('Shang Tsung','shang_.jpg',false,'Es un poderoso hechicero con la capacidad de absorber almas y cambiar de forma. Bajo el mando de Shao Kahn buscara conquistar la tierra.',true,false,9200.00),
      ('Shao Kahn','sk.jpg',false,'Emperador del Reino del Outworld.Lo conocen por su divina fuerza, la insensibilidad, extrema brutalidad y su afición por las ejecuciones personales, intentara conquistar la tierra mandando a Shang Tsung.',true,false,12000.00),
      ('Sonya Blade','sonya_.jpg',false,'miembro de una unidad superior de las Fuerzas Especiales de los Estados Unidos. Sonya representa a una mujer muy emancipada y testaruda, con obstinación y orgullo, ella se preocupa por las vidas de sus amigos y compañeros.',true,false,7900.00),
      ('Sub-Zero','sub.jpg',false,'Un asesino del clan Lin Kuei. Que asumió el mando, cuando su hermano fue asesinado por el espectro ninja Scorpion en el mismo torneo de Mortal Kombat',true,false,10000.0),
      ('Kung Lao','kunglao.jpg',false,'Monje Shaolin y un miembro de la Sociedad del Loto Blanco que se encuentra a la sombra de su antepasado. Kung Lao es el mejor amigo de Liu Kang.',true,false,98000.0);

-- Insert superheroes DC--

insert into personaje(nombre,imagen,intercambiable,descripcion,enVenta, enMiColeccion, monto)
values('Superman','superman_.jpg',false,'Superheroe nacido en el planeta de Krypton.Sus poderes provienen de la absorción solar,entre ellos se encuentran: super fuerza,super velocidad,factor curativo,volar,visión de rayos X,etc. ',true,false,15000.0),
      ('Aquaman','aquaman_.jpg',false,'Rey de Atlantis,forma parte de la Liga de La Justicia.Tiene control de los mares y criaturas marinas.Posee super fuerza y resistencia. ',true,false,8500.0),
      ('Batman','batman_.jpg',false,' Millonario que por las noches se convierte en un justiciero.Tiene una basta experiencia en multiples artes marciales.Cuenta con una inteligencia superior',true,false,10000.0),
      ('Black Adam','blackAdam_.jpg',false,' Black Adam es un antiguo egipcio llamado Teth-Adam (es decir, "Poderoso humano"), que es elegido por el mago Shazam para ser su sucesor debido a su presunta pureza moral. ',true,false,10500.0),
      ('Brainiac','brainiac_.jpg',false,'Es un villano humanoide de piel verde.Posee poderes telepáticos y psicoquinéticos cuyos límites se desconocen ',true,false,12300.0),
      ('Deadshot','deadshot_.jpg',false,'Floyd Lawton, más conocido como Deadshot, es un pistolero a sueldo, conocido por ser el segundo asesino más letal de todo el universo de DC Comics',true,false,8500.0),
      ('Flash','flash_.jpg',false,'Superheroe integrante de La Liga de La Justicia.Posee super velocidad,puede atravesar las paredes ,lanzar rayos y hasta viajar en el tiempo.',true,false,12000.0),
      ('Lex Luthor','lexLuthor_.jpg',false,'Alexander J. Luthor, conocido simplemente como Lex Luthor, es un supervillano y el archienemigo de Superman.Es un millonario con una gran inteligencia. ',true,false,10200.0),
      ('Mujer Maravilla','mujerMaravilla_.jpg',false,'Princesa guerrera de las Amazonas.Forma parte de La Liga de La Justicia.',true,false,11000.0),
      ('Deadthstroke','deadthstroke_.jpg',false,'Mercenario y villano, mentalmente inestable y con una gran habilidad en el manejo de las espadas ',true,false,7500.0);
