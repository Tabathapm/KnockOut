...
<section class="container-fluid w-100 d-flex justify-content-center align-items-center home" style="margin-top: -47%">
	<div class="d-flex justify-content-center d-flex flex-row mt-4 botones">
		<div class="row justify-content-center align-items-center" style="width: 56%;">
			<div class="col-auto bg-light p-5 rounded-3 shadow-lg opacity-75">
				...
				<%-- <p>&iquest;No ten&eacute;s  una cuenta? <a href="registro"	>Registrarme</a></p> --%>
